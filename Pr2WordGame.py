...
# check right to left
if [s for s in tableSplit if word in s]:
	wordCount += 1
...
if [s for s in contentLeftRigt if word in s]:
	wordCount += 1
...
if [s for s in contentTopBottom if word in s]:
	wordCount += 1
...
if [s for s in contentBottomTop if word in s]:
	wordCount += 1
...
for i in range(0, 2 ):
	...
	chars.clear()
	diagLR.append(temp)
if [s for s in diagLR if word in s]:
 	wordCount += 1
...
for i in range(0, 2 ):
	...
	charsRL.clear()
	diagRL.append(temp)
if [s for s in diagRL if word in s]:
 	wordCount += 1
